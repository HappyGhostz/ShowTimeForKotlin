...
//        val degree: Double
//        if (mIsRTandLB) {
//            degree = Math.PI / 4 - Math.atan2(mBezierControl1.y.toDouble() - mTouch.y, mTouch.x.toDouble() - mBezierControl1.x)
//        } else {
//            degree = Math.PI / 4 - Math.atan2(mTouch.y.toDouble() - mBezierControl1.y, mTouch.x.toDouble() - mBezierControl1.x)
//        }
//        // 翻起页阴影顶点与touch点的距离
...
//        }
//
//        rotateDegrees = Math.toDegrees(Math.atan2(mTouch.x.toDouble() - mBezierControl1.x,
//                mBezierControl1.y.toDouble() - mTouch.y)).toFloat()
...
//        }
//        rotateDegrees = Math.toDegrees(Math.atan2(mBezierControl2.y.toDouble() - mTouch.y, mBezierControl2.x.toDouble() - mTouch.x)).toFloat()
