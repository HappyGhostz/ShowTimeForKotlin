 ...
 * @description
 */
class ChapterReadBean() :Parcelable{
    /**
     * title : 1，相亲
    ...
    class Chapter  {
        ...
        constructor(title: String, body: String, cpContent: String) {
            this.title = title
            this.body = body
    ...
    companion object CREATOR : Parcelable.Creator<ChapterReadBean> {
        override fun createFromParcel(parcel: Parcel): ChapterReadBean {
            return ChapterReadBean(parcel)
        }

        override fun newArray(size: Int): Array<ChapterReadBean?> {
